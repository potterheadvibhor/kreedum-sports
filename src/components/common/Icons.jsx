// Small inline icons shared by the nav, hero, and forms.
...
export function CheckCircleIcon({ accent = "#8FADFF" }) {
  return (
    <svg width="16" height="16" viewBox="0 0 20 20" fill="none">
      <circle cx="10" cy="10" r="10" fill={accent} fillOpacity="0.2" />
      <path d="M6 10.5l2.5 2.5L14 7" stroke={accent} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  );
}
